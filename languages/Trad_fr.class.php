...
Ceci est un message automatisé. Merci de ne pas y répondre.
	...
	const T_API_ACCESS_HELP = 'Create a new user and add him to group "bbapi". Give the group "bbapi" permission for every project you want to use with API and to create new issues. This user can only use the API, he cannot login.'; // je ne parle pas français
